...
<div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <div class="view">
        <img class="d-block w-100 " src="imagenes/19.jpg"
          alt="First slide">
        <div class="mask rgba-black-light"></div>
      </div>
      <div class="carousel-caption">
        <h3 class="h3-responsive">EXPERTO<br>EN ILUSTRAR CON ACUARELA</h3>
        <p>¡Es tiempo de explorar! Te presentamos a la acuarela para composiciones botánicas, 
        durante clases descubrirás las diferencias de la ilustración botánica educativa frente 
        a la botánica decorativa.</p>
      </div>
    </div>
    <div class="carousel-item">
      <!--Mask color-->
      <div class="view">
        <img class="d-block w-100 " src="imagenes/20.jpg"
          alt="Second slide">
    ...
    <div class="carousel-item">
      <!--Mask color-->
      <div class="view">
        <img class="d-block w-100 " src="imagenes/21.jpg"
          alt="Third slide">
  ...
  <div class="row">
    ...
    <div class="col-md-4 offset-md-1 mx-3 my-3">
      ...
      <div class="view overlay">
        <img src="imagenes/18.jpg" class="img-fluid" alt="Sample image for first version of blog listing">
              <br>
              <h4 class="h4 mb-4">Un curso de Paulina Maciel, Diseñadora e ilustradora</h4>
                
              
              <p class="font-weight-normal">En este curso te enseñará, paso a paso, los procesos para realizar
               ilustraciones de composición botánica de forma precisa, tomando como modelo las flores y plantas. 
               Descubrirás el mundo natural y aprenderás a combinar la acuarela con otras técnicas como la 
                plumilla y el grafito.
              <br>
