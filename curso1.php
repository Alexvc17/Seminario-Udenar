...
<div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <div class="view">
        <img class="d-block w-100 " src="imagenes/10.jpg"
          alt="First slide">
        <div class="mask rgba-black-light"></div>
      </div>
      <div class="carousel-caption">
        <h3 class="h3-responsive">EXPERTO<br>EN DISEÑO DE PERSONAJES</h3>
        <p>Dominarás el proceso creativo del diseño de personajes pertenecientes a una narrativa, 
          historia o guión en una producción digital del largometraje de animación, 
          publicidad, videojuegos o serie de tv.</p>
      </div>
    </div>
    <div class="carousel-item">
      <!--Mask color-->
      <div class="view">
        <img class="d-block w-100 " src="imagenes/11.jpg"
          alt="Second slide">
    ...
    <div class="carousel-item">
      <!--Mask color-->
      <div class="view">
        <img class="d-block w-100 " src="imagenes/12.jpg"
          alt="Third slide">
  ...
  <div class="row">
    ...
    <div class="col-md-4 offset-md-1 mx-3 my-3">
      ...
      <div class="view overlay">
        <img src="imagenes/13.jpg" class="img-fluid" alt="Sample image for first version of blog listing">
              <br>
              <h4 class="h4 mb-4">Un curso de Jean Fraisse, Concept Artist y Director de Arte</h4>
                
              
              <p class="font-weight-normal">En el mundo de la animación y de los videojuegos todo es posible y Jean Fraisse lo ha demostrado
              creando cursos increibles en su curso de Concept Art: Introduccion al diseño de escenarios, pero esta vez, va
              un paso mas allá para llenar estos escenarios de personajes extrañables.
              <br>
